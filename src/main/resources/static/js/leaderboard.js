...
var test = new BFG.Leaderboard({
	...
	dataCallback:function(){
		return [//simulates incoming data
			{id:1,title:"Juju45",count:BFG.rnd(100)},
			{id:2,title:"quentinio",count:BFG.rnd(2000)},
			{id:3,title:"léoDu45",count:BFG.rnd(1000)},
			{id:4,title:"sands",count:BFG.rnd(250)},
			{id:5,title:"chaffai13",count:BFG.rnd(380)},
			{id:6,title:"houss",count:BFG.rnd(0)},
			{id:7,title:"moi",count:BFG.rnd(0)},
			{id:8,title:"MNI45",count:BFG.rnd(0)},
			{id:9,title:"Pattoche",count:BFG.rnd(100)},
