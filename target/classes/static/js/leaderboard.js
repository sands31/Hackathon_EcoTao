...
var test = new BFG.Leaderboard({
	...
	dataCallback:function(){
		return [//simulates incoming data
			{id:1,title:"Juju45",count:BFG.rnd(1000)},
			{id:2,title:"quentinio",count:BFG.rnd(20000)},
			{id:3,title:"léoDu45",count:BFG.rnd(10000)},
			{id:4,title:"sands",count:BFG.rnd(2500)},
			{id:5,title:"chaffai13",count:BFG.rnd(3800)},
			{id:6,title:"houss",count:BFG.rnd(0)},
			{id:7,title:"moi",count:BFG.rnd(0)},
			{id:8,title:"MNI45",count:BFG.rnd(0)},
			{id:9,title:"Pattoche",count:BFG.rnd(1000)},
			{id:10,title:"Wilder",count:BFG.rnd(0)},
			{id:11,title:"Catelyn",count:BFG.rnd(0)},
			{id:12,title:"Ygritte",count:BFG.rnd(0)},
			{id:13,title:"Jaimer",count:BFG.rnd(0)},
			{id:14,title:"Bran",count:BFG.rnd(0)},
			{id:15,title:"Varys",count:BFG.rnd(0)}
		];
	}
});
test.start();