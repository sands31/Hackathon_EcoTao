...
var test = new BFG.Leaderboard({
	...
	dataCallback:function(){
		return [//simulates incoming data
			{id:1,title:"Arya",count:BFG.rnd(100)},
			{id:2,title:"Sandor",count:BFG.rnd(0)},
			{id:3,title:"Robb",count:BFG.rnd(0)},
			{id:4,title:"Bronn",count:BFG.rnd(0)},
			{id:5,title:"Tyrion",count:BFG.rnd(0)},
			{id:6,title:"Jon",count:BFG.rnd(0)},
			{id:7,title:"Daenerys",count:BFG.rnd(0)},
			{id:8,title:"Samwell",count:BFG.rnd(0)},
			{id:9,title:"Eddard",count:BFG.rnd(100)},
			{id:10,title:"Cersei",count:BFG.rnd(0)},
